...
$ ls chunk.* | xargs -n 1 -P 1 -t -I {} bsub -q basement -o {}.bout -e {}.berr blastp -query {} -db protein.txt -out {}.blast -evalue 1E-15 -parse_deflines -outfmt 6
...
$ makeblastdb -in dna.txt -input_type fasta -parse_seqids -dbtype nucl
$ split -l 10000 dna.txt chunk.
$ ls chunk.* | xargs -n 1 -P 1 -t -I {} bsub -q basement -o {}.bout -e {}.berr blastn -query {} -db dna.txt -out {}.blast -evalue 1E-15 -parse_deflines -outfmt 6
$ cut -f 1,2,11 *.blast > seq.abc
$ mcxload -abc seq.abc -write-tab seq.dict -o seq.mci --stream-mirror --stream-neg-log10 -stream-tf 'ceil(200)'
$ mcl seq.mci -I 4
$ mcxdump -icl out.seq.mci.I40 -o dump.seq.mci.I140 -tabr seq.dict
