...
use strict;
use Getopt::Long;
use lib '/software/pathogen/external/applications/OrthoMCL_v1.4/';
use lib '/nfs/pathsoft/external/lib/perl5/site_perl/5.6.1/bioperl-live';
use File::Basename;
use orthomcl_module;

my ($mode,$fa_files,$pv_cutoff,$pi_cutoff,$pmatch_cutoff,%blast_flag,$inflation,$maximum_weight,$copy_to,$m8_blast);
...
$BLAST_FORMAT = "compact" if $m8_blast;
...
~~~~~~~~~~
 ...
 taxa_file=<String>      TAXA file provided by user, required in Mode 5. 
                         ...
                         format.
 m8blast                 Use m8 (compact) format blast results in Mode 3.
